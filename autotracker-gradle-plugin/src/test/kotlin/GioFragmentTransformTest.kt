 ...
 */
class GioFragmentTransformTest {
            ...
            classNode.methods.find { it.name == "onDestroyView" && it.desc == "()V" }.let {
                it?.instructions?.iterator()?.asIterable()?.filterIsInstance(MethodInsnNode::class.java)
                    ?.last { method ->
                        ...
                        assertThat(method.name).isEqualTo("systemFragmentOnDestroyView")
                        assertThat(method.desc).isEqualTo("(Landroid/app/Fragment;)V")
                        true
                    }
            }
                ...
                .let {
                    it?.instructions?.iterator()?.asIterable()?.filterIsInstance(MethodInsnNode::class.java)
                        ?.last { method ->
                            assertThat(method.opcode).isEqualTo(Opcodes.INVOKESTATIC)
                            assertThat(method.owner).isEqualTo("com/growingio/android/sdk/autotrack/inject/FragmentInjector")
                            assertThat(method.name).isEqualTo("systemFragmentOnResume")
                            assertThat(method.desc).isEqualTo("(Landroid/app/Fragment;)V")
                            true
                        }
                }
                ...
                .let {
                    it?.instructions?.iterator()?.asIterable()?.filterIsInstance(MethodInsnNode::class.java)
                        ?.last { method ->
                            assertThat(method.opcode).isEqualTo(Opcodes.INVOKESTATIC)
                            assertThat(method.owner).isEqualTo("com/growingio/android/sdk/autotrack/inject/FragmentInjector")
                            assertThat(method.name).isEqualTo("systemFragmentOnHiddenChanged")
                            assertThat(method.desc).isEqualTo("(Landroid/app/Fragment;Z)V")
                            true
                        }
                }
                ...
                .let {
                    it?.instructions?.iterator()?.asIterable()?.filterIsInstance(MethodInsnNode::class.java)
                        ?.last { method ->
                            assertThat(method.opcode).isEqualTo(Opcodes.INVOKESTATIC)
                            assertThat(method.owner).isEqualTo("com/growingio/android/sdk/autotrack/inject/FragmentInjector")
                            assertThat(method.name).isEqualTo("systemFragmentSetUserVisibleHint")
                            assertThat(method.desc).isEqualTo("(Landroid/app/Fragment;Z)V")
                            true
                        }
                }
